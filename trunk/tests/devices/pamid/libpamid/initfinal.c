...
int PAMID_Initialize(void)
{
	...
	PAMID_INTERNAL_STATE.context_roles.local_offload_context  = 0; //1;
	PAMID_INTERNAL_STATE.context_roles.remote_put_context     = 0; //(PAMID_INTERNAL_STATE.num_contexts > 2 ? 2 : PAMID_INTERNAL_STATE.context_roles.local_offload_context);
	PAMID_INTERNAL_STATE.context_roles.remote_get_context     = 0; //(PAMID_INTERNAL_STATE.num_contexts > 3 ? 3 : PAMID_INTERNAL_STATE.context_roles.remote_put_context);
	PAMID_INTERNAL_STATE.context_roles.remote_acc_context     = 0; //(PAMID_INTERNAL_STATE.num_contexts > 4 ? 4 : PAMID_INTERNAL_STATE.context_roles.remote_get_context);
	PAMID_INTERNAL_STATE.context_roles.remote_rmw_context     = 0; //(PAMID_INTERNAL_STATE.num_contexts > 5 ? 5 : PAMID_INTERNAL_STATE.context_roles.remote_acc_context);
	...
	if (PAMID_INTERNAL_STATE.num_contexts>1 && 0)
    {
