...
/**
 * \brief Initialize the P2P remote put descriptor info structure
 */
...
/**
 * \brief A software structure for memory fifo packets
 */
typedef union _swb
{
  struct {
...
/**
 * \brief Initialize the P2P memory FIFO descriptor info structure
 */
...
/**
 * \brief Initialize the Collective allreduce remote put descriptor
 * info structure
 */
...
/**
 * \brief Initialize the Collective allreduce memory FIFO descriptor
 * info structure
 */
